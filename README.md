V7x-Tool is great start for all Linux beginner's, you can run real linux emulator from your mobile & install best tools like Metasploit and fix issues with only one click!
